    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                { name: "Citronella", image: "https://cdn.pixabay.com/photo/2016/08/22/21/24/lemon-grass-1613796_1280.jpg", description: "Famous for repelling mosquitoes with its citrus scent.", cost: "$16" }
            ]
        },
        {
            ...
            plants: [
                ...
                { name: "Valerian", image: "https://cdn.pixabay.com/photo/2019/09/03/07/22/valerian-4449381_1280.jpg", description: "Promotes relaxation and improves sleep quality.", cost: "$17" },
                { name: "Turmeric", image: "https://cdn.pixabay.com/photo/2022/01/08/09/49/turmeric-6923638_1280.jpg", description: "Anti-inflammatory properties, used in traditional medicine.", cost: "$14" }
            ]
        },
        {
            ...
            plants: [
                ...
                { name: "Dracaena", image: "https://cdn.pixabay.com/photo/2018/03/27/16/40/dracaena-3265638_1280.jpg", description: "Tolerates low light and infrequent watering with ease.", cost: "$19" }
            ]
        }
    ];
